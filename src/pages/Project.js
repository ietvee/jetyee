...
const project = [
  ...
  },
  {
    ...
    projectName: "",
    projectDesc: "React Native app to create and delete record of data",
    projectLink:
  ...
  },
  {
    ...
    projectType: "React",
    projectName: "",
    projectDesc: "Single page web application with display of shoe content",
  ...
  },
  {
    ...
    projectName: "",
    projectDesc:
      "Flutter app to create, update & delete record of data & browse data",
    projectLink:
    ...
    <div>
      ...
      <div className="justify-self-center justify-items-center  grid-flow-row  my-12 grid lg:grid-cols-2 gap-y-8 gap-x-1  md:grid-cols-2 sm:grid-cols-1  sm:mx-1 md:mx-4 lg:mx-8">
        {project.map((item, index) => (
          <div
            className=" w-3/4 h-full mx-auto rounded-xl shadow-md overflow-hidden md:max-w-2xl sm:max-h-2xl"
            key={index}
          >
